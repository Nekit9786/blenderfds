...
class CSG(object):
    ...
    def translate(self, disp):
        ...
        for poly in self.polygons:
            for v in poly.vertices:
                v.pos = v.pos.plus(d) # no change to the normals
    ...
    def toVerticesAndPolygons(self): # FIXME Seems like it is broken
        """
        ...
        with open(filename, 'w') as f:
            ...
            for polygon in self.polygons:
                ...
                for i in range(1,len(verts)-1):
                    ...
                    f.write('    outer loop\n')
                    f.write('        vertex {v[0]:.4f} {v[1]:.4f} {v[2]:.4f}\n'.format(v=v0))
                    f.write('        vertex {v[0]:.4f} {v[1]:.4f} {v[2]:.4f}\n'.format(v=v1))
                    f.write('        vertex {v[0]:.4f} {v[1]:.4f} {v[2]:.4f}\n'.format(v=v2))
                    f.write('    endloop\n')
                    f.write('endfacet\n')
